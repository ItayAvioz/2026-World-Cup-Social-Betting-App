...
const TEAM_EXTRA = {
  ...
  'cz':     { pop:'10.9M', wcApps:2,  footballFact:'Czechoslovakia were World Cup runners-up twice — losing the 1934 final to Italy and the 1962 final to Brazil. Czech Republic itself has appeared only once before (2006).', nonFootballFact:'Has the highest beer consumption per capita in the world — over 180 litres per person per year.' },
  'ba':     { pop:'3.2M',  wcApps:2,  footballFact:'Debuted at the 2014 World Cup with Džeko and Pjanić — scored 4 goals but crashed out in the group stage. 2026 is only their second ever World Cup.', nonFootballFact:'Sarajevo hosted the 1984 Winter Olympics; its abandoned bobsled track is now one of the world\'s most famous "modern ruins" and a street-art landmark.' },
  'tr':     { pop:'88M',   wcApps:3,  footballFact:'Hakan Şükür scored the fastest goal in World Cup history — 10.8 seconds into the 3rd-place play-off vs South Korea at 2002, en route to a historic bronze.', nonFootballFact:'Produces around 70% of the world\'s hazelnuts — essentially powering the global Nutella supply.' },
  'se':     { pop:'10.5M', wcApps:13, footballFact:'Reached the top three on three occasions: runners-up in 1958 (lost 5-2 to Brazil and 17-year-old Pelé), and 3rd-place finishes in 1950 and 1994.', nonFootballFact:'Invented Bluetooth — and Alfred Nobel, creator of the Nobel Prizes, was Swedish.' },
  'iq':     { pop:'48M',   wcApps:2,  footballFact:'Won the 2007 AFC Asian Cup in one of sport\'s most emotional moments — uniting a war-torn nation. Ahmed Radhi\'s 1986 WC goal remains the only World Cup goal in Iraqi history.', nonFootballFact:'Home to Mesopotamia, the "Cradle of Civilisation" and the birthplace of writing — cuneiform script dates back to ~3400 BC.' },
  'cd':     { pop:'116M',  wcApps:2,  footballFact:'Competed as Zaire in 1974 — a player famously booted the ball away mid-free-kick vs Brazil. Conceded 14 goals in 3 games including a 9-0 loss to Yugoslavia. Returning after 52 years.', nonFootballFact:'The Congo River is the deepest river on Earth (over 220m), and the country holds the world\'s second-largest rainforest after the Amazon.' },
};
